...
import { addMonths, startOfMonth, format, startOfDay, isAfter } from "date-fns";
import { Calendar } from "@/Components/ui/calendar";
import { Button } from "@/Components/ui/button";
import { useAppointmentSlots } from "@/hooks/use-appointment-slots"; // Assuming the hook is in this path
import { TimeSlot } from "@/types"; // Assuming types are in this path

...
export default function DoctorCard({
  ...
  return (
    <Card className="w-full flex flex-col gap-4 max-w-sm rounded-lg shadow-lg overflow-hidden bg-background p-6 border border-border-2">
      <CardContent className="p-0 w-full flex flex-col md:flex-row items-center md:gap-3 gap-4">
        <div className="relative shrink-0 mt-1.5">
          <div className="rounded-full w-12 h-12 md:w-16 md:h-16 overflow-hidden">
            {imageUrl ? (
              <Image
                src={imageUrl}
                fill
        ...
        <div className="min-w-0 flex-1 w-full">
          ...
          <p className="body-regular text-text-body truncate">{specialty}</p>
